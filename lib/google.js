  ...
  _createClass(Google, [{
    ...
    value: function render() {
      return _react2.default.createElement('ins', { className: this.props.className + ' adsbygoogle',
        ...
        'data-matched-content-ui-type':this.props.matchedContentUiType,
        'data-ad-format': this.props.format,
        'data-matched-content-row-num:':this.props.matchedContentRowsNum,
        'data-matched-content-columns-num:':this.props.matchedContentColsNum,
...
Google.propTypes = {
  ...
  matchedContentRowsNum: _propTypes2.default.string,
  matchedContentColsNum: _propTypes2.default.string,
  matchedContentUiType: _propTypes2.default.string,
